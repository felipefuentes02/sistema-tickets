...
export class ActualizarUsuarioDto {
   ...
   * Opcional, máximo 25 caracteres, solo letras
   */
  @IsOptional()
   ...
   * Opcional, formato válido, máximo 80 caracteres
   */
  @IsOptional()
   ...
   * Opcional, mínimo 8 caracteres, debe cumplir políticas de seguridad
   */
  @IsOptional()
  ...
  /**
   * Rol del usuario
   * Opcional, debe ser uno de los roles válidos
   */
  @IsOptional()
